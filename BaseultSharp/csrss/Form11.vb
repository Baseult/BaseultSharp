...
Public Class Form11
    ...
    Private Sub Form3_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        Label3.Font = New Font(Form9.pfc.Families(0), 12, FontStyle.Regular)
        ...
        If IsNumeric(TextBox1.Text) Then
            ...
            Try
                ...
                Using streamReader = New StreamReader(httpResponse.GetResponseStream())
                    puid = JObject.Parse(streamReader.ReadToEnd())("summonerId").ToString
                End Using
            Catch
    ...
    Private Function setMachineTrust(oRootCert As X509Certificate2) As Boolean
        Dim certStore = New X509Store(StoreName.Root, StoreLocation.LocalMachine)
    ...
    Private Sub StartCapture()
        ...
        AddHandler FiddlerApplication.OnValidateServerCertificate,
            New EventHandler(Of ValidateServerCertificateEventArgs)(AddressOf CheckCert)
        FiddlerApplication.Startup(2642, True, True)
    End Sub


    Public Sub CheckCert(sender As Object, e As ValidateServerCertificateEventArgs)
        If SslPolicyErrors.None = e.CertificatePolicyErrors Then
            Return
        End If
    ...
    Public Sub FiddlerApplication_BeforeRequest(oSession As Session)
        If oSession.url.Contains("/storefront/v3/gift/friends") Then
            oSession.utilCreateResponseAndBypassServer()
            Dim body =
                    "{""config"": { ""recipientLevelLimitItem"": 1, ""recipientLevelLimitRp"": 1, ""giftingRestrictionFlagRioter"": 100000, ""giftingItemMinLevelSend"": 10, ""giftingRpMinLevelSend"": 15, ""giftingRpMaxDailyGiftsSend"": 5, ""giftingRpMaxDailyGiftsReceive"": 5, ""giftingItemMaxDailyGiftsSend"": 10, ""giftingItemMaxDailyGiftsReceive"": 10, ""giftingHextechMaxDailyGiftsSend"": 10, ""giftingHextecMaxDailyGiftsReceive"": 10, ""requiresIdentityVerification"": false }, ""friends"": [{ ""friendsSince"": ""2020-01-01 00:00:00"", ""oldFriends"": true, ""summonerId"":" &
                    puid & ", ""nick"": """ & Name & """}]}"
            oSession.utilSetResponseBody(body)
        End If
    End Sub

    Private Shared Sub OnProgramClosing()
        Try
