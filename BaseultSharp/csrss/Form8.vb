...
Public Class Form8
    ...
    Private Sub B1_Click(sender As Object, e As EventArgs) Handles B1.Click
        ...
        Try
            ...
            Using streamReader = New StreamReader(httpResponse.GetResponseStream())
                TextBox2.Text = TextBox2.Text + vbCrLf + "[" + DateTime.Now.ToString("hh:mm:ss") + "] Chat: Sent " &
                                TextBox1.Text & " Exploit-Message"
            End Using
        Catch
            TextBox2.Text = TextBox2.Text + vbCrLf + "[" + DateTime.Now.ToString("hh:mm:ss") +
                            "] Chat: Account not found? This only works with Players in your friend list!"
        End Try
    End Sub
    ...
    Private Sub TextBox1_Click(sender As Object, e As EventArgs) Handles TextBox1.Click
        If TextBox1.Text.Contains("Enter Friends Summoner Name or ID") Then
            TextBox1.Text = ""
        End If
    End Sub
